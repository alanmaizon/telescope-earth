!function(t, e) {
    ...
    const n = (t, e, n) => Math.min(Math.max(n, t), e),
        r = .001;
    function o({duration: t=800, bounce: e=.25, velocity: o=0, mass: a=1}) {
        let i,
            c,
            u = 1 - e;
        u = n(.05, 1, u),
        ...
        }) : (i = e => Math.exp(-e * t) * ((e - o) * t + 1) - .001, c = e => Math.exp(-e * t) * (t * t * (o - e)));
    ...
    function u(t) {
        ...
        let {stiffness: h, damping: m, mass: g, velocity: y, duration: b, isResolvedFromDuration: M} = function(t) {
                let e = Object.assign({
                    velocity: 0,
                    stiffness: 100,
                    damping: 10,
        ...
        function x() {
            const t = y ? -y / 1e3 : 0,
                ...
                o = m / (2 * Math.sqrt(h * g)),
                a = Math.sqrt(h / g) / 1e3;
            if (void 0 === p && (p = Math.min(Math.abs(r - n) / 100, .4)), o < 1) {
                const n = s(a, o);
                v = s => {
    ...
    const O = (x = "%", {
        test: t => b(t) && t.endsWith(x) && 1 === t.split(" ").length,
        parse: parseFloat,
        transform: t => `${t}${x}`
    });
    var x;
    ...
    const w = (t, e) => n => Boolean(b(n) && y.test(n) && n.startsWith(t) || e && Object.prototype.hasOwnProperty.call(n, e)),
        ...
        I = {
            ...
            transform: ({hue: t, saturation: e, lightness: n, alpha: r=1}) => "hsla(" + Math.round(t) + ", " + O.transform(h(e)) + ", " + O.transform(h(n)) + ", " + h(v.transform(r)) + ")"
        },
        A = d(0, 255),
        ...
        P = {
            ...
            transform: ({red: t, green: e, blue: n, alpha: r=1}) => "rgba(" + D.transform(t) + ", " + D.transform(e) + ", " + D.transform(n) + ", " + h(v.transform(r)) + ")"
        };
    const S = {
            test: w("#"),
            parse: function(t) {
    ...
    function q(t) {
        ...
        const o = t.match(m);
        return o && (t = t.replace(m, k), e.push(...o.map(M.parse))), {
            values: e,
            numColors: n,
            tokenised: t
        }
    ...
    function $(t) {
        ...
        return t => {
            let e = r;
            for (let r = 0; r < o; r++)
                e = e.replace(r < n ? C : k, r < n ? R(t[r]) : h(t[r]));
            return e
        }
    }
    ...
    const X = (t, e) => {
        ...
        Y = (t, e) => {
            const n = Object.assign(Object.assign({}, t), e),
                r = {};
            for (const o in n)
                void 0 !== t[o] && void 0 !== e[o] && (r[o] = Q(t[o], e[o]));
            return t => {
                for (const e in r)
                    n[e] = r[e](t);
                return n
    ...
    function Z(t) {
        ...
        let r = 0,
            ...
            s = 0;
        for (let t = 0; t < n; t++)
            r || "number" == typeof e[t] ? r++ : void 0 !== e[t].hue ? s++ : o++;
        return {
            parsed: e,
            numNumbers: r,
            numRGB: o,
    ...
    const ot = t => e => 1 - t(1 - e),
        st = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
        at = t => e => Math.pow(e, t),
        it = t => e => e * e * ((t + 1) * e - t),
        ct = t => {
            const e = it(t);
    ...
    function jt({velocity: t=0, from: e=0, power: n=.8, timeConstant: r=350, restDelta: o=.5, modifyTarget: s}) {
        const a = {
            done: !1,
            value: e
        };
    ...
    const Rt = {
        ...
        kt = Ct.reduce(((t, e) => (t[e] = function(t) {
            let e = [],
                n = [],
                r = 0,
                o = !1,
    ...
    const $t = t => kt[t].process(Rt),
        Bt = t => {
            Tt = !1,
            Rt.delta = St ? At : Math.max(Math.min(t - Rt.timestamp, 40), 1),
            Rt.timestamp = t,
            Ft = !0,
            Ct.forEach($t),
            Ft = !1,
    ...
    function Ht(t) {
        ...
        (null === (r = (n = A).needsInterpolation) || void 0 === r ? void 0 : r.call(n, o, O)) && (v = rt([0, 100], [o, O], {
            clamp: !1
        }), o = 0, O = 100);
        const D = A(Object.assign(Object.assign({}, y), {
            from: o,
            to: O
        }));
        function P() {
            x++,
            "reverse" === l ? (I = x % 2 == 0, i = function(t, e, n=0, r=!0) {
                return r ? zt(e + -t, e, n) : e - (t - e) + n
            }(i, w, p, I)) : (i = zt(i, w, p), "mirror" === l && D.flipTarget()),
            j = !1,
            m && m()
        }
        function S(t) {
            ...
            null == g || g(M),
            j && (0 === x && (null != w || (w = i)), x < c ? function(t, e, n, r) {
                return r ? t >= e + n : t <= -n
            }(i, w, p, I) && P() : (b.stop(), h && h()))
        }
        return s && (null == f || f(), b = a(S), b.start()), {
            stop: () => {
                null == d || d(),
                b.stop()
            }
    ...
    t.backOut = yt,
    t.bounceIn = Ot,
    t.bounceInOut = t => t < .5 ? .5 * (1 - vt(1 - 2 * t)) : .5 * vt(2 * t - 1) + .5,
    t.bounceOut = vt,
    t.circIn = dt,
    t.circInOut = mt,
    t.circOut = ht,
    ...
    t.cubicBezier = function(t, e, n, r) {
        ...
        function s(e) {
            ...
            return i >= .001 ? function(t, e, n, r) {
                ...
                return e
            }(e, a, t, n) : 0 === i ? a : function(t, e, n, r, o) {
                let s,
                    a,
                    i = 0;
                do {
    ...
    t.easeInOut = ft,
    t.easeOut = pt,
    t.inertia = function({from: t=0, velocity: e=0, min: n, max: r, power: o=.8, timeConstant: s=750, bounceStiffness: a=500, bounceDamping: i=10, restDelta: c=1, modifyTarget: u, driver: l, onUpdate: p, onComplete: f, onStop: d}) {
        let h;
        function m(t) {
        ...
        function y(t) {
            null == h || h.stop(),
            h = Ht(Object.assign(Object.assign({}, t), {
                driver: l,
                onUpdate: e => {
                    var n;
                    null == p || p(e),
    ...
    t.mixComplex = tt,
    t.pipe = K,
    t.pointFromVector = (t, e, n) => (e = Qt(e), {
        x: n * Math.cos(e) + t.x,
        y: n * Math.sin(e) + t.y
    }),
    t.progress = p,
